    ...
    try {
      ...
      const message = {
        ...
        from: {
          ...
          name: this.config.sender_name || 'PMG - Personalization Maturity Generator'
        },
            ...
            <div style="max-width: 600px; margin: 0 auto; padding: 20px; background-color: #ffffff;">
              ...
              <div style="margin-top: 40px; padding-top: 20px; border-top: 1px solid #e5e7eb; font-size: 14px; color: #6b7280; text-align: center;">
                <p style="margin-bottom: 10px;">
                  <strong>Generated by PMG - Personalization Maturity Generator</strong>
                </p>
...
---
Generated by PMG - Personalization Maturity Generator
