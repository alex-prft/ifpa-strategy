...
import { Calendar, Settings, Database, Users, TrendingUp, AlertCircle, Save, RefreshCw, Webhook, Activity, CheckCircle, XCircle, TestTube, Key, BarChart, Map, FileText, Cog, Layers, Monitor, Play, Pause, Download, Clock, AlertTriangle, Zap, Network, Terminal } from 'lucide-react';
...
// OPAL Monitoring Content Component
// Agent Status Circle Colors:
// - Gray (bg-gray-400): Unknown status (waiting for workflow trigger)
// - Green (bg-green-500): Successfully receiving OPAL data
// - Red (bg-red-500): Failed to receive OPAL data
function OPALMonitoringContent() {
  ...
  // Agent status tracking - colors will change based on OPAL data reception
  ...
  // Get agent status tooltip text
  const getAgentStatusTooltip = (status: 'unknown' | 'success' | 'failed') => {
    switch (status) {
      case 'success': return 'Agent Status: Successfully receiving OPAL data';
      case 'failed': return 'Agent Status: Failed to receive OPAL data';
      case 'unknown':
      default: return 'Agent Status: Unknown (waiting for workflow trigger)';
    }
  };
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex items-center gap-3 p-3 bg-gray-50 rounded-lg">
                      <div
                        className={`w-4 h-4 rounded-full ${getAgentStatusColor(agentStatuses.integration_health)}`}
                        title={getAgentStatusTooltip(agentStatuses.integration_health)}
                      ></div>
                      <div className="flex-1">
                    ...
                    <div className="flex items-center gap-3 p-3 bg-gray-50 rounded-lg">
                      <div
                        className={`w-4 h-4 rounded-full ${getAgentStatusColor(agentStatuses.content_review)}`}
                        title={getAgentStatusTooltip(agentStatuses.content_review)}
                      ></div>
                      <div className="flex-1">
                    ...
                    <div className="flex items-center gap-3 p-3 bg-gray-50 rounded-lg">
                      <div
                        className={`w-4 h-4 rounded-full ${getAgentStatusColor(agentStatuses.geo_audit)}`}
                        title={getAgentStatusTooltip(agentStatuses.geo_audit)}
                      ></div>
                      <div className="flex-1">
                    ...
                    <div className="flex items-center gap-3 p-3 bg-gray-50 rounded-lg">
                      <div
                        className={`w-4 h-4 rounded-full ${getAgentStatusColor(agentStatuses.audience_suggester)}`}
                        title={getAgentStatusTooltip(agentStatuses.audience_suggester)}
                      ></div>
                      <div className="flex-1">
                    ...
                    <div className="flex items-center gap-3 p-3 bg-gray-50 rounded-lg">
                      <div
                        className={`w-4 h-4 rounded-full ${getAgentStatusColor(agentStatuses.experiment_blueprinter)}`}
                        title={getAgentStatusTooltip(agentStatuses.experiment_blueprinter)}
                      ></div>
                      <div className="flex-1">
                    ...
                    <div className="flex items-center gap-3 p-3 bg-gray-50 rounded-lg">
                      <div
                        className={`w-4 h-4 rounded-full ${getAgentStatusColor(agentStatuses.personalization_idea_generator)}`}
                        title={getAgentStatusTooltip(agentStatuses.personalization_idea_generator)}
                      ></div>
                      <div className="flex-1">
                    ...
                    <div className="flex items-center gap-3 p-3 bg-gray-50 rounded-lg">
                      <div
                        className={`w-4 h-4 rounded-full ${getAgentStatusColor(agentStatuses.customer_journey)}`}
                        title={getAgentStatusTooltip(agentStatuses.customer_journey)}
                      ></div>
                      <div className="flex-1">
                    ...
                    <div className="flex items-center gap-3 p-3 bg-gray-50 rounded-lg">
                      <div
                        className={`w-4 h-4 rounded-full ${getAgentStatusColor(agentStatuses.roadmap_generator)}`}
                        title={getAgentStatusTooltip(agentStatuses.roadmap_generator)}
                      ></div>
                      <div className="flex-1">
                    ...
                    <div className="flex items-center gap-3 p-3 bg-gray-50 rounded-lg">
                      <div
                        className={`w-4 h-4 rounded-full ${getAgentStatusColor(agentStatuses.cmp_organizer)}`}
                        title={getAgentStatusTooltip(agentStatuses.cmp_organizer)}
                      ></div>
                      <div className="flex-1">
